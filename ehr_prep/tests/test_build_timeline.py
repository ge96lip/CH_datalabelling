...
def l1_fixture(tmp_path: Path):
    ...
    """
    root = tmp_path / "ehr_store" / "normalized"
    # RAD (free-text-like)
    _write_l1_part(
        ...
        [
            ...
            dict(source_tranche="T01", source_file="rad.txt", line_start=1, line_end=5,
                 ...
                 section_hints=None, modality_specific='{"exam_type":"CT"}'),
            dict(source_tranche="T01", source_file="rad.txt", line_start=6, line_end=12,
                 ...
                 section_hints=None, modality_specific='{"exam_type":"XR"}'),
            # EMPI_B
    ...
    _write_l1_part(
        ...
        [
            dict(source_tranche="T01", source_file="phy.txt", line_start=1, line_end=1,
                 ...
                 section_hints=None, modality_specific='{"Concept_Name":"Vitals"}'),
            dict(source_tranche="T01", source_file="phy.txt", line_start=2, line_end=2,
                 ...
                 section_hints=None, modality_specific='{"Concept_Name":"BP"}'),
        ]
    )
...
def test_build_and_load_single_patients(l1_fixture: Path):
    tmp = l1_fixture
    l1_glob = (tmp / "ehr_store" / "normalized" / "tranche=*" / "mod=*" / "*.parquet").as_posix()
    l2_dir  = (tmp / "ehr_store" / "timeline_ds").as_posix()
